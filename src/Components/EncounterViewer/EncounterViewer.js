  ...
  console.log(patientName);
        ...
        return (
          <Container fluid css={{height: "80vh"}}>
            ...
            {encounters.data.length > 0 ? (<Table>
              <Table.Header>
            ...
            </Table>) : (<Container display="center" css={{height: "100%", display: "grid", placeContent: "center"}}><Text align="center" h4 css={{
              height: "100%",
            }} >This patient doesn't have any encounters yet.</Text></Container>) }
          </Container>
        )
